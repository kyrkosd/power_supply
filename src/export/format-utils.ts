// SI unit formatters shared by bom-export.ts and pdf-report.ts.
// All functions accept SI base-unit values and return human-readable strings.

/** Format a Henry value with automatic mH / µH / nH scaling. */
...
/** Format a Farad value with automatic mF / µF / nF scaling. */
...
/** Format an Ohm value with automatic Ω / mΩ / µΩ scaling. */
...
/** Format a Hz value with automatic MHz / kHz / Hz scaling. */
